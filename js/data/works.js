...
,
  ...
  {
    id: "magicians",
    series: { name: "魔法师（The Magicians）", members: ["小说三部曲（2009–2014）", "Syfy 剧集（5 季 · 2015–2020）", "衍生漫画《Alice's Story》等"] },
    treeLit: ["F3", "L4", "B4", "W3"],
    year: 2009,
    title: "魔法师",
    creator: "莱夫·格罗斯曼（Lev Grossman）",
    media: "小说 / 电视剧",
    era: "当代（魔法学院 + 魔法异界）",
    setting: "这部作品把「进入魔法学校」的幻想与「魔法王国」的向往逐一拆穿：布瑞克比尔斯学院里的魔法是一门需苦修、易致伤的技术，而非与生俱来的天赋；魔法异界 Fillory 虽如纳尼亚般宏伟，却同样有政治的残忍、权谋与背叛。它站在哈利·波特与纳尼亚的肩头上，写一部祛魅版的当代奇幻。",
    physicalDivergences: [
      "魔法是学来的技术：以手势与咒语引导能量，代价是练习中的灼伤、断指与意志损耗。",
      "通向 Fillory 的入口（旧拱门、魔法钥匙）通往一个真实、危险且有自己的神的异界。",
      "时间与灵魂可被魔法回溯与切割，但每次越界都以更深的代价偿还。"
    ],
    mythSources: ["纳尼亚式魔法异界的互文", "当代学院派魔法（哈利波特母题的祛魅挪用）"],
    representativeTechs: ["mg-brakebills", "mg-fillory", "mg-beast", "mg-hedgewitch"]
  },
];
...
const WORKS_META = {
  ...
  "magicians": {
    story: "被布瑞克比尔斯学院录取的高中生昆汀·柯德沃特，在得知魔法并非幻想而是可学的技术后，发现自己的抑郁并不因此消解；他与同学们一同进入魔法异界 Fillory，直面「野兽」的威胁。",
    synopsis: "昆汀与朱莉娅、爱丽丝、艾略特、玛戈（玛格）等布瑞克比尔斯同窗，在学院、人间与 Fillory 之间穿行：追踪野兽、寻找金钥匙、重启魔法泉源，也在权谋与牺牲中反复受挫。电视剧在此基础上把朱莉娅的野道魔法与各方阵营的政治博弈大力展开，共五季。",
    background: "莱夫·格罗斯曼是《时代》周刊书评人，写《魔法师》时有意把少年向的魔法幻想与成人世界的失望并置，被称为「给成人的哈利·波特」；电视剧由 Syfy 改编，2015 年首播至 2020 年共五季。",
    author: "莱夫·格罗斯曼（Lev Grossman，1973– ），美国作家、《时代》书评人，三部曲代表作。大陆中文版《魔法师》由上海译文出版社 2013 年出版；台版由天下文化以《費洛瑞之書》译介。"
  },
};
